...
export default function PurchaseVendorsPage() {
  ...
  function sendWhatsApp(entry: VendorRow) {
    ...
    const message = `नमस्कार ${entry.vendor_name}, या ${new Date(entry.date).toLocaleDateString("en-IN")} रोजी ₹${entry.amount.toLocaleString("en-IN")} ची खरेदी करण्यात आली होती. सदर बाकी रक्कम ₹${remaining.toLocaleString("en-IN")} आहे. कृपया पayment करण्यासाठी संपर्क करा.`;
