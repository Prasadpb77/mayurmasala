...
export default function PurchaseVendorsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (insertError) {
      console.error("Failed to insert purchase vendor entry:", insertError);
      ...
      <main className="flex-1 p-4 md:p-6 space-y-6">
          ...
          <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center" onClick={() => setShowAdd(false)}>
            ...
            <div className="relative bg-masala-cream w-full md:max-w-sm rounded-t-2xl md:rounded-2xl p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-bold text-lg">Add Purchase Vendor Entry</h3>
        ...
        {rows.length > 0 && (
          <div className="card p-4 md:p-5">
            <h3 className="font-semibold mb-3">All Purchase Entries</h3>
