...
import { LayoutGrid, ShoppingCart, PackagePlus, Receipt, LogOut } from "lucide-react";
...
export default function Nav() {
  ...
  return (
    <div className="w-60 shrink-0 min-h-screen bg-masala-gradient text-masala-cream flex flex-col">
